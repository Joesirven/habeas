"""Paylocity HR API error classification."""
...
class PaylocityErrorClassifier:
    """Map Paylocity error codes to shared queue dispositions."""
...
def classify_paylocity_error(
    error_code: str,
    error_payload: dict[str, Any] | None = None,
) -> TerminalAction:
    """Classify a Paylocity error and return the terminal workflow action."""
    return classify_with(PaylocityErrorClassifier(), error_code, error_payload)
