...
| [`transform/external_hash/`](transform/external_hash/) | dbt marts for Auth0-only hashed indexes — hashed raw only; Axios HQ (`axios_headquarters`) is upload-every-batch (no `axios_hashed_raw` invented this slice) |
